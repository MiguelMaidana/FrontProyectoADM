...
query obternerCliente($id:ID!){
    obternerCliente(id:$id){
        nombre
        apellido
        empresa
        email
...
const EditarCliente = () => {
    ...
    // Atualizar el cliente

    const[actualizarCliente] = useMutation(ACTUALIZAR_CLIENTE)

    //Squema de validacion 
    ...
    //console.log(data.obternerCliente)
    const{obternerCliente} = data
